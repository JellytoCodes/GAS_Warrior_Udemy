...
{
	const bool bIsCheckDeadStatus = UWarriorFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, WarriorGameplayTags::Shared_Status_Dead)
...
{
	if (CachedDefaultMaxWalkSpeed > 0.f) GetHeroCharacterFromActorInfo()->GetCharacterMovement()->MaxWalkSpeed = CachedDefaultMaxWalkSpeed;
}
