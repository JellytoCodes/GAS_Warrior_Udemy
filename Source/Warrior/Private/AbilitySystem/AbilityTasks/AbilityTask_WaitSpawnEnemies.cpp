...
void UAbilityTask_WaitSpawnEnemies::OnDestroy(bool bInOwnerFinished)
{
	...
	// Caution : When overriding this function make sure to call Super::OnDestroy(bInOwnerFinished) as the last
...
void UAbilityTask_WaitSpawnEnemies::OnEnemyClassLoaded()
{
	...
	for (int32 i = 0 ; i < CachedNumToSpawn ; i++)
	{
		...
		if (AWarriorEnemyCharacter* SpawnEnemy = World->SpawnActor<AWarriorEnemyCharacter>(LoadedClass, RandomLocation, SpawnFacingRotation, SpawnParam))
		{
